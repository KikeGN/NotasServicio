...
public class ActivityRecordatorios extends AppCompatActivity {
    ...
    private ListaAdapter3 listViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recordatorios_tarea);
    ...
    private void setAdapters(String id) {
        ...
        listViewAdapter = new ListaAdapter3(getBaseContext(), R.layout.lista3, daoRecordatorios.getrecordatoriosnota(id));
