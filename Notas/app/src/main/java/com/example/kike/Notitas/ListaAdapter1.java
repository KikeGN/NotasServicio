...
public class ListaAdapter1 extends ArrayAdapter<Notas> {
    public ListaAdapter1(Context context, int resource, List<Notas> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(null == v) {
            ...
            v = inflater.inflate(R.layout.lista1, null);
        }
